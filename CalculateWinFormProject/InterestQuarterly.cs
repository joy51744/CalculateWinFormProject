...
{
    public partial class InterestQuarterly : Form
    {
        public InterestQuarterly()
        {
            InitializeComponent();
        }
        ...
        private void buttonCalculate_Click(object sender, EventArgs e)
        {
            ...
            quarterRate = InterestRate / 4;
            Period = Years * 4;
            Rate = Principal * (decimal)Math.Pow((1 + quarterRate), (double)Period);
            Total = (decimal)Rate;
